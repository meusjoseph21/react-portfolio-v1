          ...
          <div className="move">
            ...
            <div className="bottom w3-animate-bottom">
              <a
                ...
                href="https://github.com/meusjoseph21"
                target="_blank"
              >
              ...
              <a
                className={classes.marginIcons}
                href="https://www.facebook.com/jmeus1"
                target="_blank"
              >
              ...
              <a
                className={classes.marginIcons}
                href="mailto:meusjoseph21@gmail.com"
                target="_blank"
              >
              ...
              <a
                className={classes.marginIcons}
                href="https://www.linkedin.com/in/joseph-meus-4b8b071b4/"
                target="_blank"
              >
              ...
              <a
                className={classes.marginIcons}
                href="https://open.spotify.com/user/j.meus?si=R2H2FCzzQkaMdb40Q42dJA"
                target="_blank"
              >
              ...
              <a
                className={classes.marginIcons}
                href="https://www.instagram.com/josmuse/?hl=en"
                target="_blank"
              >
